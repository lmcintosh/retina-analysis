function ex = setupCorrExptKB(ex)
% ex = setupCorrExptKB
%
% Sets up the keyboard for the Baccus lab expts, mostly for debugging
%
...
% response keynames. each refers to which grating (left or right) was
% faster
k.left = k.fKey;
k.right = k.jKey;
