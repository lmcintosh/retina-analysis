function ex = setupSimpleEdgesParams(ex)
%
% FUNCTION ex = setupSimpleEdgesParams(ex)
%
% The function setupSimpleEdgesParams sets up the experimental parameters used
% in the SimpleEdges experiment.
%
% see also: RunSimpleEdgesExpt.m
%
...
%% basic information
ex.pa.experimentName = 'SimpleEdges';
